# Import road data at the hexagon resolution 7 level
...
############
# Obtain road data at resolution 7 from database
############
...
# Save to pickle file
df_roads.to_pickle('../../../data/filter/road_features_h7_uk.pkl')